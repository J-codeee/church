        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="card-glass p-6 text-center hover:shadow-lg transition-all duration-300">
              <h3 className="text-xl font-serif font-semibold text-primary-900 dark:text-white mb-4">Faith</h3>
            ...
            <div className="card-glass p-6 text-center hover:shadow-lg transition-all duration-300">
              <h3 className="text-xl font-serif font-semibold text-primary-900 dark:text-white mb-4">Community</h3>
              <p className="text-neutral-700 dark:text-neutral-200">
            ...
            <div className="card-glass p-6 text-center hover:shadow-lg transition-all duration-300">
              <h3 className="text-xl font-serif font-semibold text-primary-900 dark:text-white mb-4">Service</h3>
              <p className="text-neutral-700 dark:text-neutral-200">
          ...
          <div className="card-glass p-8">
            <p className="text-neutral-700 dark:text-neutral-200 leading-relaxed text-center">
